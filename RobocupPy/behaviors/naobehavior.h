...
// For UT Walk
#include "../utwalk/MotionCore.h"
#include "../utwalk/memory/Memory.h"
#include "../utwalk/memory/FrameInfoBlock.h"
#include "../utwalk/memory/SensorBlock.h"
#include "../utwalk/memory/JointBlock.h"
#include "../utwalk/memory/JointCommandBlock.h"
#include "../utwalk/memory/SimEffectorBlock.h"
#include "../utwalk/memory/WalkRequestBlock.h"
...
protected:
    ...
    SkillType gotoFieldPosOffensive();
    SkillType gotoFieldPosDefensive();
    SkillType gotoFieldPosOurKickOff(int _playerNumber);
    SkillType gotoFieldPosTheirKickOff(int _playerNumber);
    SkillType gotoFieldPosBeforeKickOff(int _playerNumber);
    SkillType gotoFieldPosTheirFreeKick(int _playerNumber);
    SkillType DribblingPairsSmartish();
    ...
    SkillType BasicTree(VecPosition _myPos, int pNum, double* _teamMateDistances, double* _opponentDistances);


    bool isPossesion(double* _opponentDistances, double* _teamMateDistances);
    bool isClosestTeam(int _player, double* _teamMateDistances);
    bool isSafeToKick(double* _opponentDistances);
    bool isShootingRange(VecPosition _player);
    bool isFarToBall(int _playerNumber,double* _teamMateDistances);
    bool atDestination(VecPosition mypos, VecPosition target);
    bool isClosestPlayertoBall(int pNum, double* _opponentDistances, double* _teamMateDistances);

    bool isOffensiveStrat(int pNum, double* _opponentDistances, double* _teamMateDistances);
    ...
    bool DangerClose(double* _opponentDistances);

    int getXFieldRegion(VecPosition mypos);
    int getYFieldRegion(VecPosition objpos);
    
    void DistanceToBallArrayTeammates(int pNum, double* _teamMateDistances);
    void DistanceToBallArrayOpponents(double* _opponentDistances);

    VecPosition getClosestTeammatePos(int _playerNumber,double* _teamMateDistances);
    VecPosition ValidateFieldPos(VecPosition target);
    VecPosition getPartnerPos(int pNum);
    VecPosition GetDesiredTarget(int pNum, VecPosition mypos, VecPosition partner, int regionX, int regionY, bool closest);
